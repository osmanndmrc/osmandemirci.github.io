    ...
    init:function(){
        ...
        $('#submit').click(function(){
            ...
            if($('.contact-form .required').size()  > 0 ){
                ...
                $.post( base_url + "/contact.php", $( "#contact" ).serialize(),function( data ) {
...
window.initialize = function() {
    ...
    var mapOptions = {
        center: new google.maps.LatLng(40.702931, -73.905489),
        zoom:15,
    ...
    var marker = new google.maps.Marker({
        position: new google.maps.LatLng(40.702931, -73.905489),
