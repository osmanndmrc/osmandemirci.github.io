Magnetic = new (function () {
    ...
    function J(a) {
        if (a.keyCode == 37)s(-1); else a.keyCode == 39 && s(1)
    }
    ...
    function C() {
        ...
        e.width = i;
        e.height = j;
        var a = (window.innerWidth - i) * 0.5, b = (window.innerHeight - j) * 0.5;
    ...
    var r = navigator.userAgent.toLowerCase().indexOf("android") != -1 || navigator.userAgent.toLowerCase().indexOf("iphone") != -1 || navigator.userAgent.toLowerCase().indexOf("ipad") != -1, i = r ? window.innerWidth : 800, j = r ? window.innerHeight :
        550, F = 20, p = 300, e, d, t, q = [], f = [], n = window.innerWidth - i, o = window.innerHeight - j, w = false, x = 0, g = 0, k = [{
        glowA: "rgba(8, 253, 216, 0.3)",
        glowB: "rgba(254, 8, 83, 0.0)",
        particleFill: "#08fdd8",
